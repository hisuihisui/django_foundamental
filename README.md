...
　→　管理ツールでユーザーを登録する
2. グループとフレンド<br>
　→　フレンドの投稿のみ閲覧可能、フレンドはグループにまとめて管理
3. 投稿とシェア<br>
　→　メッセージはグループへ投稿、誰かが投稿したものをシェアする投稿も可能
4. publicグループ<br>
　→　全ての利用者に公開されるグループ
5. Good機能<br>
　→いいねボタン
...
### その他の仕様
1. トップページに表示されるメッセージ<br>
・フレンド登録しているかつ所属しているグループへのメッセージのみ閲覧可能
2. ページネーションは1ページあたり10メッセージ<br>
...
### テスト
TestCaseを継承したクラスを作成し、test_〇〇というメソッドを作成する
```
